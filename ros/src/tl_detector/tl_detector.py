...
class TLDetector(object):
    ...
    def get_closest_waypoint(self, x, y):
        ...
        """
        closest_idx = self.waypont_tree.query([x,y],1)[1]
        return closest_idx
    ...
    def get_light_state(self, light):
        ...
        # #Comment all code and return light.state (given state of light - only for simulator)
        return light.state
